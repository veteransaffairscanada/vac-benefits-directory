const questions = [
  {
    ...
    summary_english: "Who will be receiving the benefits:",
    summary_french: "Qui recevra les avantages :",
  ...
  },
  {
    ...
    summary_english: "Service type:",
    summary_french: "Type de service:",
  ...
  },
  {
    ...
    "questionClearLogic 2 copy":
      "Unnamed record, Unnamed record, Unnamed record",
    tooltip_english:
      "A service-related health issue is an illness or injury that was caused or worsened by military service. It must be medically diagnosed by a doctor. Examples include: hearing loss and tinnitus, depression, or a shoulder injury.",
    tooltip_french:
    ...
    summary_english: "Is there a service-related health issue?",
    summary_french: "A-t-il un problème de santé lié au service?",
  ...
  },
  {
    ...
    summary_english: "Categories of benefits:",
    summary_french: "Catégories d’avantages :",
  ...
  {
    id: "recEv3U5Kmsp6KSPM",
    variable_name: "feedback",
    display_text_english:
      "Overall, how was your experience with this online tool?",
    display_text_french:
      "(fra) Overall, how was your experience with this online tool?",
    multiple_choice_options: [
      "reclaTGtFPEjKNXat",
      "reca3onCEzVopM1xc",
      "rec9Flp9oGEodmRY8",
